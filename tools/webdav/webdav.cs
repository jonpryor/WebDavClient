		...
		public static void Main (string[] args)
		{
			...
			var o = new OptionSet {
				...
				{ "user=",
				  ...
				  v => (c.Builder.Credentials ?? (c.Builder.Credentials = new NetworkCredential ())).UserName = v },
				{ "pass=",
				  "Set {PASSWORD} on WebDAV server to connect to.",
				  v => (c.Builder.Credentials ?? (c.Builder.Credentials = new NetworkCredential ())).Password = v },
				{ "version",
